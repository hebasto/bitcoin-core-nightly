...
| [clang-cl](https://clang.llvm.org/docs/UsersManual.html#clang-cl) | [![Windows, clang-cl](https://github.com/hebasto/bitcoin-core-nightly/actions/workflows/windows-clang-cl.yml/badge.svg)](https://github.com/hebasto/bitcoin-core-nightly/actions/workflows/windows-clang-cl.yml?query=event%3Aschedule) | "Release" configuration<br>No functional tests |
